...
const Sidebar = memo(function Sidebar({
  ...
  const SidebarContent = useMemo(() => (
    <>
      ...
      <nav className="flex-1 px-3 md:px-4 py-4 md:py-6 overflow-y-auto" role="navigation">
        ...
        <div className="mb-4 md:mb-6">
          ...
          <ul className="space-y-2 md:space-y-3" role="list">
            ...
            >
              ...
              >
                <motion.div
                  ...
                  transition={girando ? { duration: 1, repeat: Infinity, ease: "linear" } : {}}
                >
                  <FaRandom className="text-purple-600 group-hover:scale-110 transition-transform duration-200 flex-shrink-0" size={isMobile ? 14 : 18} />
                </motion.div>
                <span className="text-xs md:text-sm truncate">{girando ? "Girando..." : "Ruleta Aleatoria"}</span>
              </motion.button>
            </motion.li>
            ...
            >
              ...
              >
                <FaQuestionCircle 
                  className={`${preguntaActiva ? "text-blue-100" : "text-green-600"} group-hover:scale-110 transition-transform duration-200 flex-shrink-0`} 
                  size={isMobile ? 14 : 18} 
                />
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <FaQrcode className="text-orange-600 group-hover:scale-110 transition-transform duration-200 flex-shrink-0" size={isMobile ? 14 : 18} />
                <span className="text-xs md:text-sm truncate">Mostrar Código QR</span>
              </motion.button>
            </motion.li>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <FaStop className="text-red-600 group-hover:scale-110 transition-transform duration-200 flex-shrink-0" size={isMobile ? 14 : 18} />
                <span className="text-xs md:text-sm truncate">Finalizar Clase</span>
              </motion.button>
            </motion.li>
          </ul>
        </div>
        ...
        <div className="mt-auto">
          ...
          >
            <FaSignOutAlt className="text-gray-600 group-hover:scale-110 transition-transform duration-200 flex-shrink-0" size={isMobile ? 14 : 18} />
            <span className="text-xs md:text-sm truncate">Regresar al Dashboard</span>
          </motion.button>
        </div>
      </nav>
    </>
